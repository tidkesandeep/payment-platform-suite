"""Test-only factory: mint an official L1–L3 chain with ephemeral ES256 keys.

Uses the published `verifiable_intent` issuance API. Private keys never leave
this process and are not written to disk.
"""
...
def mint_chain(
    *,
    ...
    issuer_priv = generate_es256_key()
